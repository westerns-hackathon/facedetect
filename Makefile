...
# Do everything.
install: deps download sudo_pre_install_clean build sudo_install clean install dlib

# Do everything on Raspbian.
install_raspi: deps download sudo_pre_install_clean build_raspi sudo_install clean

# Do everything on the raspberry pi zero.
install_raspi_zero: deps download sudo_pre_install_clean build_raspi_zero sudo_install clean

# Do everything on Jetson.
install_jetson: deps download sudo_pre_install_clean build_jetson sudo_install clean

# Do everything with cuda.
install_cuda: deps download sudo_pre_install_clean build_cuda sudo_install clean verify_cuda
...
install_nonfree: deps download sudo_pre_install_clean build_nonfree sudo_install clean
